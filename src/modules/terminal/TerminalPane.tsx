...
export const TerminalPane = memo(
  forwardRef<TerminalPaneHandle, Props>(function TerminalPane(
    ...
    // Plain (non-blocks) mode. The xterm grid fills the pane directly; command
    // history now lives in the pane header (TerminalHistoryPopover), so there's
    // no in-terminal overlay to position against here.
    return (
      <div
        ref={containerRef}
