...
const THEME_FILE_EXT = ".koden-theme";
const THEME_EDIT_EVENT = "koden://theme-edit";
    ...
    variants: {
      dark: {
        ...
        terminal: {
          ...
          cursor: "#e8e8ea",
          cursorAccent: "#0d0d10",
          selection: "rgba(125,211,252,0.45)",
          selectionForeground: "#0d0d10",
          selectionInactive: "rgba(125,211,252,0.28)",
        },
      },
    },
  };
