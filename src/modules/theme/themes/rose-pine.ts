  ...
  variants: {
    dark: {
      ...
      terminal: {
        cursor: "#e0def4",
        cursorAccent: "#191724",
        selection: "rgba(196,167,231,0.45)",
        selectionForeground: "#191724",
        selectionInactive: "rgba(196,167,231,0.28)",
        ansi: [
    ...
    light: {
      ...
      terminal: {
        cursor: "#575279",
        cursorAccent: "#faf4ed",
        selection: "rgba(144,122,169,0.42)",
        selectionForeground: "#faf4ed",
        selectionInactive: "rgba(144,122,169,0.26)",
        ansi: [
