...
export function createCommandItems(
  ...
  return [
    ...
    {
      id: "ai.toggle",
      title: "Toggle Librarian chat",
      group: "AI",
      keywords: ["assistant", "chat", "agent", "librarian"],
      icon: SparklesIcon,
    ...
    {
      id: "ai.askSelection",
      title: "Ask the Librarian about selection",
      group: "AI",
      keywords: ["selection", "explain", "assistant", "chat", "librarian"],
      icon: SparklesIcon,
