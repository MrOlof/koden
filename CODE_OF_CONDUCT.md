...
Koden is a small open-source project and we want it to stay a place people enjoy contributing to.
...
- **Stay on topic.** Issues, PRs, and discussions are about Koden. Take off-topic conversations elsewhere.
...
If you see a violation — or experience one — open an issue or email the maintainer with subject `[Koden conduct]`. Include links and context.
