...
async fn open_settings_window(app: tauri::AppHandle, tab: Option<String>) -> Result<(), String> {
    ...
    if let Some(window) = app.get_webview_window("settings") {
        ...
        if let Some(t) = tab.as_deref().filter(|s| !s.is_empty()) {
            ...
            let _ = window.emit("koden:settings-tab", t);
        }
        return Ok(());
    }
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            brain::commands::brain_hotspots,
            brain::commands::brain_changed_between,
            brain::commands::brain_plan_context,
            ...
            brain::commands::brain_resolve_proposal,
            ...
            brain::commands::brain_resume_plan,
            brain::commands::brain_dismiss_recovered,
            brain::commands::brain_record_turn,
            ...
            net::ai_http_request,
            net::ai_http_stream,
            usage::usage_guard_set,
            usage::usage_guard_snapshot,
